...
import com.bsl.mrapp.BslLoginActivity;
...
public class SpUtil {
     ...
     * @return List集合
     */
    public static ArrayList<HashMap<String,Object>> getLists(Context context, String key) {
        try {
            return (ArrayList<HashMap<String,Object>>) get(context, key);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return null;
