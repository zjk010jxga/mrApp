...
public class SpendingFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle saveInstanceState){
        View rootView = inflater.inflate(R.layout.fragment_transaction_spending,container,false);
        return rootView;
    ...
    public void onActivityCreated(Bundle saveInstanceState){
        ...
        initTrading();//初始化数据
        RecyclerView recyclerView =getActivity().findViewById(R.id.recycle_view2);
    ...
    private void initTrading(){
        for(int i = 0; i < 2; i++){
            ...
            Trading withdrawal5 = new Trading("红包","-200","2018-04-06 13:37:08");
